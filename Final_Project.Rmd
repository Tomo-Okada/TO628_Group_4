...
We recommend using boosting or random forest techniques to improve the final decision tree analysis even further. We also recommend further exploring Country as a variable, as it will likely lead to significant distinctions as well.
