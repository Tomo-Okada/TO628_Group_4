...
We interpret Model 2 in the following manner. 
...
* Using loan status 1 (Current), as a baseline, those with loan status 2 (Chargeoff) on average have a borrower's rate that is higher by 1.574. 
* Those with loan status 3 on average have a borrower's rate that is higher than those with loan status 1 by 0.4938. 
* Those with loan status 4 on average have a borrower's rate that is higher than those with loan status 1 by 0.1411.   
